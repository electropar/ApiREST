...
namespace AccesoDatos
{
    ...
    public partial class C_FONDO_FIJO
    {
        ...
        public Nullable<short> U_solicitante { get; set; }
        public string U_denominacion { get; set; }
        public string U_responsable { get; set; }
        public Nullable<int> U_monto_asignado { get; set; }
