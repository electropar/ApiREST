...
namespace AccesoDatos
{
    ...
    public partial class AJDT
    {
        ...
        public string U_Reconcilia { get; set; }
        ...
        public string U_nrocompretencion { get; set; }
        public string U_ruccliente { get; set; }
        public string U_informante { get; set; }
        public string U_idcontrolSET { get; set; }
        public Nullable<System.DateTime> U_fecha_emision { get; set; }
        public string U_nrofactura { get; set; }
        public string U_timbrado { get; set; }
        public string U_estado { get; set; }
        public Nullable<System.DateTime> U_fecha_anulacion { get; set; }
        public string U_conceptiva { get; set; }
        public string U_conceptorenta { get; set; }
    }
}
