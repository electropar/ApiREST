...
namespace AccesoDatos
{
    ...
    public partial class C_MOVIL
    {
        ...
        public string U_reparto { get; set; }
        public string U_particular { get; set; }
        public string U_marca { get; set; }
        public string U_modelo { get; set; }
        public short U_anho { get; set; }
        public int U_km_inicial { get; set; }
    }
}
