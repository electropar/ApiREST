...
namespace AccesoDatos
{
    ...
    public partial class C_CIRCUITO_DOCUMENTOS
    {
        ...
        public Nullable<int> U_nro_documento { get; set; }
        public string U_nro_folio { get; set; }
        public Nullable<System.DateTime> U_fecha_contab { get; set; }
        public string U_tipo_documento { get; set; }
        public string U_nombre_cliente { get; set; }
        public Nullable<int> U_usersign2 { get; set; }
        public Nullable<decimal> U_doctotal { get; set; }
        public string U_localizacion { get; set; }
        public string U_accion { get; set; }
        public string U_tipo { get; set; }
        public string U_observacion { get; set; }
        public string U_tipo_original { get; set; }
