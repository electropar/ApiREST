...
namespace AccesoDatos
{
    ...
    public partial class UITM
    {
        ...
        public string U_ind_iva_imp { get; set; }
        public string U_ind_aranc_adu { get; set; }
        public string U_Coleccion { get; set; }
        public Nullable<int> U_maximo_descuento { get; set; }
        public string U_cod_art { get; set; }
        public short U_T_EMBARQUE { get; set; }
        public Nullable<short> U_T_TOTAL_GESTION { get; set; }
        public Nullable<short> U_T_DIAS_STOCK { get; set; }
        public string U_U_COD_BARRA { get; set; }
        public decimal U_stk_min_gen { get; set; }
        public decimal U_stk_max_gen { get; set; }
        public string U_stk_act_cont { get; set; }
        public int U_maximo_descuento_1 { get; set; }
        public string U_claseABC { get; set; }
        public string U_part_aran { get; set; }
        public Nullable<int> U_Arancel { get; set; }
        public short U_equivalencia { get; set; }
        public string U_medida_articulo { get; set; }
        public decimal U_max_desc_ra { get; set; }
        public short U_verificado { get; set; }
        public Nullable<short> U_origen { get; set; }
        public decimal U_por_liquidacion { get; set; }
        public string U_familia_producto { get; set; }
        public Nullable<int> U_frec_compra { get; set; }
        public string U_itemcode_replace { get; set; }
        public string U_resp_aba_especiali { get; set; }
        public string U_resp_aba_analista { get; set; }
        public decimal U_comision_1 { get; set; }
        public decimal U_comision_2 { get; set; }
        public Nullable<System.DateTime> U_vigencia_1 { get; set; }
        public Nullable<System.DateTime> U_vigencia_2 { get; set; }
        public short U_picking { get; set; }
        public int U_canal_control { get; set; }
        public int U_multiplo_venta { get; set; }
        public string U_resp_mkt_analista { get; set; }
        public string U_linea { get; set; }
        public int U_rev_tecnica { get; set; }
        public string U_rev_tecnica_pasos { get; set; }
        public short U_despreciable { get; set; }
        public short U_tipo_stock { get; set; }
        public decimal U_periodo_garantia { get; set; }
        public string U_donde_verificar { get; set; }
        public string U_paletizar { get; set; }
        public int U_reponer_depositos { get; set; }
        public string U_tipo_comision { get; set; }
        public int U_ecommerce { get; set; }
        public string U_ecommerce_articulo { get; set; }
        public Nullable<decimal> U_descuento1 { get; set; }
        public Nullable<decimal> U_descuento2 { get; set; }
        public int U_MOQ { get; set; }
        public string U_accion { get; set; }
        public string U_ref_alternativa { get; set; }
        public string U_intn { get; set; }
        public Nullable<short> U_certificado_origen { get; set; }
    }
}
