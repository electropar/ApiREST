...
namespace AccesoDatos
{
    ...
    public partial class OCRD
    {
        ...
        public Nullable<System.DateTime> U_fec_ing_emp { get; set; }
        public Nullable<System.DateTime> U_fec_ani_emp { get; set; }
        public string U_RETENCION { get; set; }
        public Nullable<decimal> U_LimiteCredito { get; set; }
        public Nullable<decimal> U_LimiteCreditoC { get; set; }
        public Nullable<int> U_USUARIO { get; set; }
        public Nullable<short> U_CondicionPago { get; set; }
        public short U_Cuenta_bloq { get; set; }
        public string U_cod_sn { get; set; }
        public string U_LIBER_AUT { get; set; }
        public string U_sub_grupo { get; set; }
        public Nullable<short> U_idcobrador { get; set; }
        public Nullable<short> U_idvendedor { get; set; }
        public string U_frec_contacto { get; set; }
        public string U_creado_por { get; set; }
        public string U_revisado { get; set; }
        public string U_EXTR { get; set; }
        public Nullable<short> U_diaContacto { get; set; }
        public string U_prov_rub { get; set; }
        public string U_prov_hab { get; set; }
        public string U_prov_crit { get; set; }
        public string U_id_gestor { get; set; }
        public string U_TipoRet { get; set; }
        public string U_escpub { get; set; }
        public string U_obra { get; set; }
        public int U_sol_cre_nro { get; set; }
        public Nullable<int> U_AutPolPrecio { get; set; }
        public Nullable<System.DateTime> U_AutPolPrecioFecha { get; set; }
        public string U_ConMotCom { get; set; }
        public Nullable<short> U_dia_pago { get; set; }
        public string U_frecuencia_dia { get; set; }
        public string U_segmento { get; set; }
        public Nullable<short> U_dia_gestion { get; set; }
        public string U_horario_pago { get; set; }
        public Nullable<System.DateTime> U_fec_lim_fac { get; set; }
        public short U_no_cast { get; set; }
        public short U_funcionario { get; set; }
        public string U_consolidar_en { get; set; }
        public string U_oc_obligatorio { get; set; }
        public string U_nombre_fantasia { get; set; }
        public short U_tipo_socio_negocio { get; set; }
        public Nullable<short> U_canje { get; set; }
        public Nullable<short> U_remision { get; set; }
        public Nullable<short> U_estado { get; set; }
        public Nullable<int> U_id_RRHH { get; set; }
        public string U_clasificacion { get; set; }
        public string U_division { get; set; }
        public string U_grupo_economico { get; set; }
        public string U_ruta { get; set; }
        public short U_clasificacion_mora { get; set; }
        public Nullable<System.DateTime> U_fecha_vencimiento { get; set; }
        public Nullable<decimal> U_meta_cliente { get; set; }
        public string U_accion_comercial { get; set; }
        public string U_satisfaccion { get; set; }
        public string U_comentario_satis { get; set; }
        public Nullable<decimal> U_cant_contacto_meta { get; set; }
        public Nullable<decimal> U_descuento_adiciona { get; set; }
        public string U_devoluciones { get; set; }
        public string U_cambios_mercaderia { get; set; }
        public string U_muestras { get; set; }
        public string U_envio_mercaderia { get; set; }
        public string U_entrega_parcial { get; set; }
        public string U_presentes { get; set; }
        public string U_visita_tecnico { get; set; }
        public string U_asesoramiento { get; set; }
        public Nullable<int> U_rapidez_resp { get; set; }
        public string U_cobranzas { get; set; }
        public string U_lista_morosidad { get; set; }
        public string U_atencion_mostrador { get; set; }
        public string U_quejas { get; set; }
        public string U_preparado { get; set; }
        public string U_atencion_tel { get; set; }
        public string U_fuerza_ataque { get; set; }
        public string U_tipo_cliente { get; set; }
        public string U_zona_alta { get; set; }
        public string U_clasificacion_merc { get; set; }
        public string U_email_cobranza { get; set; }
        public Nullable<short> U_sdk { get; set; }
        public string U_clasificacion_vol { get; set; }
        public string U_gerente_cuenta { get; set; }
        public Nullable<decimal> U_importe_min_prov { get; set; }
        public Nullable<decimal> U_importe_min_elec { get; set; }
        public string U_moneda_compra { get; set; }
        public int U_canal_control { get; set; }
        public int U_rem_fact_prov { get; set; }
        public Nullable<decimal> U_coeficiente { get; set; }
        public string U_sucursal { get; set; }
        public Nullable<int> U_lista_descuento { get; set; }
        public Nullable<int> U_desc_adicional { get; set; }
        public string U_prov_resp_eval { get; set; }
        public Nullable<short> U_bloq_sobre_giro { get; set; }
        public string U_zoho_migrar { get; set; }
        public string U_zoho_ID { get; set; }
        public string U_ejecutivo_cuenta { get; set; }
        public string U_CodPais { get; set; }
        public string U_CodDepto { get; set; }
        public string U_CodDistrito { get; set; }
        public string U_CodCiudad { get; set; }
        public string U_email_FE { get; set; }
    }
}
