...
namespace AccesoDatos
{
    ...
    public partial class ORCT
    {
        ...
        public Nullable<int> U_BP_Seque { get; set; }
        public string U_clas_dif { get; set; }
        public string U_cod_cobrador { get; set; }
        public string U_nombre_cobrador { get; set; }
        public string U_suc { get; set; }
        public Nullable<System.DateTime> U_fecha_alta { get; set; }
        public string U_hora_alta { get; set; }
        public string U_CnxLoc { get; set; }
        public string U_TipoRete { get; set; }
        public string U_CalcRete { get; set; }
        public Nullable<decimal> U_RETENCION2 { get; set; }
        public Nullable<int> U_oc_numero { get; set; }
        public string U_nombre_aut { get; set; }
        public Nullable<System.DateTime> U_fecha_pago { get; set; }
        public string U_email { get; set; }
        public string U_gestor { get; set; }
        public string U_motivo_canje { get; set; }
        public Nullable<System.DateTime> U_fecha_reposicion { get; set; }
        public string U_beneficiario_canje { get; set; }
        public Nullable<short> U_nro_reposicion { get; set; }
        public string U_timb { get; set; }
        public Nullable<short> U_tercero { get; set; }
        public string U_concepto_pago { get; set; }
        public Nullable<decimal> U_receipt_id_cast { get; set; }
        public Nullable<int> U_nro_pronet { get; set; }
    }
}
